...
export default function LoginModal({ onClose,openSignup,openLogin }) {
...
//       axios.post(`${process.env.NEXT_PUBLIC_API_URL}/users/login`,formData)
//     );
  // const result = await postApi("/users/login", formData);
        ...
        <div className="mt-3 space-y-4">
          ...
          <div className="flex justify-between items-center text-sm">
            <label className="flex items-center gap-2  text-black">
              <input type="checkbox" className="accent-green-600  text-black border-2 border-gray-400 md:cursor-pointer" />
              Remember me
            </label>
          ...
          {/* Login Button */}
          <button className="w-full bg-lime-500 text-white py-3 rounded-xl hover:bg-lime-500 transition md:cursor-pointer" onClick={handlesubmit}>
            Login
          </button>
          ...
          <button className="w-full border py-3 rounded-xl bg-white hover:bg-gray-100 transition flex items-center justify-center gap-3 md:cursor-pointer">
            <span><Image src={google} alt=""></Image></span>
          ...
          <p className="text-center text-sm mt-4  text-black">
            ...
            <button className="text-lime-500 font-medium hover:underline md:cursor-pointer" onClick={()=>{onClose(),openSignup()}} >
              Sign Up
            </button>
          </p>
        </div>
