...
export default function ListingCard({ refreshKey,setrefreshKey }) {
  ...
  console.log("this is top 3 list", apiRes);


  return (
    <section
      className={`min-w-sm max-w-303 mx-auto mb-10 flex flex-col  ${viewModal == true ? "fixed" : " "}`}
    >
          ...
          return (
            ...
            >
              ...
              <div className="p-5 space-y-3  flex flex-col flex-grow">
                ...
                <div className="flex gap-3 pt-1 top-20 mb-3">
                  <button
                    className="w-[75%] border-2  h-12 bg-lime-600 py-2 text-white rounded-lg hover:bg-lime-700 cursor-pointer"
                    onClick={() => {
